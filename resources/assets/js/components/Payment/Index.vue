            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-text text-center position-relative">
                        <div class="loading-text"  v-if="reportData === 'loading' || reportData === 'no-data'">
...
export default {
    ...
    methods: {
        ...
        initializeCharts() {
            this.chartRefs.byWorks = new this.Chart(document.getElementById('reporter_1_by_works').getContext("2d"), {
                'type': "pie",
                'options': {
                    'title': {
                        'display': true,
        ...
        updateReports() {
            if (this.reportData === "no-data") {    
                this.chartRefs.byWorks.data = {};
                this.chartRefs.byWorks.destroy();
            } else {
